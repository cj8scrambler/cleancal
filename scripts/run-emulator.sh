...
echo "3. VNC client connection string (IMPORTANT!):"
echo "   - TigerVNC/TightVNC: vncviewer localhost:0"
echo "   - gvncviewer: gvncviewer localhost::5900 (double colon!)"
echo "4. Run diagnostics: ./scripts/check-vnc.sh"
echo "5. Check container logs: docker logs <container-id>"
