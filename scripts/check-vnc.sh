...
echo "Connect with:"
echo ""
echo "  # TigerVNC, TightVNC, RealVNC (display number syntax):"
echo "  vncviewer localhost:0"
echo ""
echo "  # gvncviewer / GNOME VNC Viewer (port syntax with double colon):"
echo "  gvncviewer localhost::5900"
echo ""
echo "  # Alternative clients (if they accept port directly):"
echo "  vncviewer localhost:5900"
echo ""
echo "⚠️  IMPORTANT: gvncviewer interprets 'localhost:5900' as display 5900"
echo "   which maps to port 11800! Use 'localhost::5900' instead."
echo ""
